    ...
    <header style={{
      ...
      <div style={{ background: "#1E3A8A", color: "white", fontSize: 13, padding: "7px 0" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <a href="https://wa.me/905510244156" target="_blank" rel="noopener noreferrer" style={{ color: "white", textDecoration: "none", fontWeight: 600, display: "flex", alignItems: "center", gap: 5 }}>
